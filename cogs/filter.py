...
class filter(commands.Cog):
    ...
    @commands.command(
        help="This will put a jail effect over the profile",
        ...
        async with aiohttp.ClientSession() as session:
            async with session.get(url, data=data) as resp:
                f = await aiofiles.open(
                    f"./tempstorage/overlay{ctx.author.id}.png", mode="wb"
                )
    ...
    @commands.command(
        help="This will put a glass effect over the profile",
        extras={"category": "Search"},
        usage="[@member]",
        description="Image overlays for you discord profile pic",
    )
    ...
    @commands.command(
        help="This will put a comrade effect over the profile",
        extras={"category": "Search"},
        usage="[@member]",
        description="Image overlays for you discord profile pic",
    )
    ...
    @commands.command(
        help="This will put a wasted effect over the profile",
        extras={"category": "Search"},
        usage="[@member]",
        description="Image overlays for you discord profile pic",
    )
    ...
    @commands.command(
        help="This will put a passed effect over the profile",
        extras={"category": "Search"},
        usage="[@member]",
        description="Image overlays for you discord profile pic",
    )
    ...
    @commands.command(
        help="This will put a triggered effect over the profile",
        extras={"category": "Search"},
        usage="[@member]",
        description="Image overlays for you discord profile pic",
    )
    ...
    @commands.command(
        help="This will put a Greyscale effect over the profile",
        extras={"category": "Search"},
        usage="[@member]",
        description="Image overlays for you discord profile pic",
    )
    ...
    @commands.command(
        help="This will put a sepia effect over the profile",
        extras={"category": "Search"},
        usage="[@member]",
        description="Image overlays for you discord profile pic",
    )
    ...
    @commands.command(
        help="This will put a Blurple  effect over the profile",
        extras={"category": "Search"},
        usage="[@member]",
        description="Image overlays for you discord profile pic",
    )
    ...
    @commands.command(
        help="This will put a Blurple old effect over the profile",
        extras={"category": "Search"},
        usage="[@member]",
        description="Image overlays for you discord profile pic",
    )
    ...
    @commands.command(
        name="wanted",
        help="This will put a Wanted old effect over the profile",
        description="Image overlays for you discord profile pic",
    )
    ...
    @commands.command(
        name="trash",
        help="This will put a Trash old effect over the profile",
        extras={"category": "Search"},
        usage="[@member]",
        description="Image overlays for you discord profile pic",
    )
    async def Trash_dot(self, ctx, member: discord.Member = None):
        if member is None:
            member = ctx.author
    ...
    async def Trash_slash(self, ctx, member: discord.Member = None):
        if member is None:
            member = ctx.author
    ...
    @commands.slash_command(
        name="ghost", description="This will put a Trash old effect over the profile"
    )
