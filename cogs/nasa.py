...
class Nasa(commands.Cog):
    ...
    async def apod_(self, ctx):
        ...
        data = response.json()
        embed = discord.Embed(
            title=data["title"], description=data["explanation"], color=0x00168B
        )
        ...
        embed.add_field(
            name="Link to image of the day/video", value=data["url"], inline=False
        )
    ...
    @commands.slash_command(
        name="apod_lookup", description="NASA Astronomy Picture of the Day Lookup"
    )
