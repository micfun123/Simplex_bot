...
class pokemon(commands.Cog):
    ...
    @commands.command(name = "pokidex",aliases=['pokedex'], help = "This will show you the pokedex of the pokemon", description="Shows you the pokedex of the pokemon")	
    async def pokidex_(self, ctx, *, name):
        if len(name.split(" ")) == 1:
            try:
    ...
    @discord.slash_command(name = "pokidex", aliases=['pokedex'], help = "This will show you the pokedex of the pokemon", description="Shows you the pokedex of the pokemon")	
